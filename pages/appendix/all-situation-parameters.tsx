...
const AllSituationParametersTable = (props) => {
  ...
  return (
    <Layout pageTitle="Appendix: All Situation Parameters">
      <Table
        style={{ maxWidth: '95vw' }}
        ...
        scroll={{ x: 1000 }}
        columns={[]} // Note: map over all grammatical features and add a column for each one.
        // columns={[
        //   {
        //     title: 'Feature',
        //     key: 'feature',
...
export default AllSituationParametersTable;

export async function getStaticProps(context) {
  const response = await (
    await fetch(`${server}/api/data-tables/principal-component-features`)
  ).json();
